...
from robosuite.environments.manipulation.agent_simulation.agent_gripper_model  import Gripper_2FG7
import time
from robosuite.environments.manipulation.agent_simulation.agent_eyes_camera import EyesCamera
...
config = {'pick1':  ['yellow block', 'green block', 'blue block',
                    'yellow brick_small', 'green cylinder', 'green roof', 'red triangle'],
        'pick':  ['yellow block', 'green block', 'blue block',],
          'place': []}
...
class SimulationEnv():
    ...
    def reset(self):
        ...
        print('   +++ The current path of agent_simulation, agent_ur3e: ', os.getcwd())
    ...
    def get_observation(self):
        print('   --- get_observation from agent_simulation/ur3e.py')
        """
...
eval_env = SimulationEnv(mode='expl')
...
trainer = trainer_class(
        ...
        target_qf2=target_qf2,
         {"discount": 0.99,"policy_lr": 3e-05, "qf_lr": 3e-05,
    "reward_scale": 1,
