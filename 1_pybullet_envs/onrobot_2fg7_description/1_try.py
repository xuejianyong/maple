...
bikeid = p.loadURDF("./urdf/onrobot_2fg7_upload.urdf", startPos, startOrientation)
#robotid = p.loadURDF("ur3e.urdf", [1, 0, 0])
#numJoints = p.getNumJoints(robotid)
#print(' !!! robot numjoints: ', numJoints)

#pos = [0.1339999999999999, -0.49199999999872496, 0.5]
#rot = p.getQuaternionFromEuler([np.pi, 0, np.pi])
#robotiq_gripper_simple = p.loadURDF("bowl.urdf",  [1, 0, 0])

#robotiq_gripper_simple = p.loadURDF("/onrobot_2fg7_description/urdf/onrobot_2fg7_upload.urdf", pos)
