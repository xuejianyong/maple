...
class PickPlaceEnv:
    ...
    def reset(self, config):
        ...
        # table = pybullet.loadURDF(TABLE_URDF_PATH, [0.5, 0, -0.6300], [, 0, 0, 1])
        ...
        #self.ghost_id = pybullet.loadURDF("../ur3e/ur3e.urdf", [0, 0, -10])
        ...
        print('   *** robot ur3e joint number: ', pybullet.getNumJoints(self.robot_id))
        ...
        self.gripper = RG3(self.robot_id, self.ee_link_id)
